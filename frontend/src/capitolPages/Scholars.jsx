...
const Scholars = () => {
  ...
  const fetchScholars = async () => {
    try {
      const response = await axios.get('https://brgy-scholarship-distribution-system-18.onrender.com/api/capitol/get-scholars')
  ...
  const handleRelease = async () => {
    try {
      const res = await axios.post('https://brgy-scholarship-distribution-system-18.onrender.com/api/capitol/release-scholarship');
    } catch (error) {
