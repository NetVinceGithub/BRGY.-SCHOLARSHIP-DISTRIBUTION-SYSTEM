...
const Beneficiaries = () => {
  ...
  const fetchBeneficiaries = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://brgy-scholarship-distribution-system-11.onrender.com/api/beneficiaries/get-beneficiaries?userId=${userId}`,
        {
          headers: {
  ...
  const handleDelete = async (id) => {
    ...
    if (window.confirm('Are you sure you want to delete this beneficiary?')) {
      setError(null);
      try {
        await axios.delete(`https://brgy-scholarship-distribution-system-11.onrender.com/api/beneficiaries/delete/${id}`);
  ...
  const handleModalSave = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://brgy-scholarship-distribution-system-11.onrender.com/api/beneficiaries/update/${idToUse}`, 
        selectedBeneficiary
      );
  ...
  const handleTransfer = async () => {
    try {
      ...
      const res = await axios.post(`https://brgy-scholarship-distribution-system-11.onrender.com/api/beneficiaries/transfer-to-capitol?userId=${userId}`, null, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
